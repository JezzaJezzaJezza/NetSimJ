...
// Engine   : BasicEngine
// Traffic  : Random
// Faults   : node=0.0, edge=0.0, seed=42
...
#define SIM_LITE_ENGINE 0
  ...
  inline BaseTopo make_topology() { return BaseTopo(15); }

  // Fault injection
  inline constexpr unsigned rng_seed        = 42;
  inline constexpr double   node_fault_prob = 0.0;
  inline constexpr double   edge_fault_prob = 0.0;
